...
Int_t FeMirror3a(){
  ...
  // Hysteresis1&2
  //  namestr[1]="20210716081447_list.root"; // Fe 30 nm, B=0 mT
  //namestr[2]="20210715072653_list.root"; //Fe 30 nm, theta = 0.69 deg., x = 0.0 mm, B = 8 mT
  //namestr[2]="20210715075452_list.root"; //Fe 30 nm, theta = 0.69 deg. x = 0.0 mm , B = 0 mT
  //namestr[3]="20210715081447_list.root"; //Fe 30 nm, theta = 0.69 deg. x = 0.0 mm , B = -8 mT -> 0 mT
  //namestr[2]="20210715081447_list.root"; //Fe 30 nm, theta = 0.69 deg. x = 0.0 mm , B = -8 mT -> 0 mT
  //namestr[4]="20210715084835_list.root"; //Fe 30 nm, theta = 0.69 deg., x = 0.0 mm, B = 1 mT from -8 mT
  //namestr[5]="20210715085349_list.root"; //Fe 30 nm, theta = 0.69 deg., x = 0.0 mm, B = 1.5 mT from -8 mT
  //namestr[6]="20210715082606_list.root"; //Fe 30 nm, theta = 0.69 deg. x = 0.0 mm , B = 0 mT  -> 2 mT


  namestr[1]="20210715081447_list.root";
  // Fe 30 nm, B = 0 mT
  namestr[2]="20210715072653_list.root";
  // Fe 30 nm, B = 6 mT
  namestr[3]="20210716230107_list.root";
  // Fe 90 nm, B = 0 m
  namestr[4]="20210716232122_list.root";
  // Fe 90 nm, B = 6 mT
  namestr[5]="20210717051355_list.root";
  namestr[6]="20210717052755_list.root";
  // Fe 50 nm, B = 0 mT, AFP ON

  //namestr[5]="20210717004515_list.root";
  // namestr[6]="20210716235619_list.root";
 ...
 // degstr[2]="Fe 30 nm, #theta = 0.69 deg., B = 8 mT with AFP";
  ...
  // Hysteresis1&2
  //degstr[1]="B = -8 mT --> 0 mT (sample C)" ;
  //degstr[2]="B = -8 mT -->  0 mT" ;
  degstr[1]="(a) Fe 30 nm, 0 mT";
  degstr[2]="(a) Fe 30 nm, 6 mT";
  degstr[3]="(c) Fe 90 nm, 0 mT";
  degstr[4]="(c) Fe 90 nm, 6 mT";
  degstr[5]="(b) Fe 50 nm, 0 mT, AFP";
  degstr[6]="(b) Fe 50 nm, 0 mT";

  //  degstr[4]="B = -8 mT --> 8 mT (sample C) w AFP" ;
  //degstr[2]="I=0.265A" ;
  //  degstr[5]="I=0A";
  //degstr[6]="scan I=0.27-0.27A";
  ...
  angle[2] = TMath::Abs(47. - xdirect)/dist_det; //rad
  angle[3] = TMath::Abs(47. - xdirect)/dist_det; //rad
  angle[4] = TMath::Abs(51. - xdirect)/dist_det; //rad
  angle[5] = TMath::Abs(51. - xdirect)/dist_det; //rad
  angle[6] = TMath::Abs(51. - xdirect)/dist_det; //rad

  //  TLegend* leg = new TLegend(0.15, 0.75, 0.4, 0.98,"");
  TLegend* leg = new TLegend(0.70, 0.20, 0.98, 0.70,"Fe 30 nm / Fe 90 nm");
  leg->SetFillColor(0);
