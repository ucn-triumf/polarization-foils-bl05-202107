...
Int_t FeMirror4a(){
  ...
  // Hysteresis1&2
  namestr[1]="20210716230107_list.root";
  //  namestr[1]="20210715072653_list.root"; //Fe 30 nm, theta = 0.69 deg., x = 0.0 mm, B = 8 mT
  ...
  namestr[2]="20210716235619_list_.root"; //Fe 30 nm, theta = 0.69 deg. x = 0.0 mm , B = 2 mT  -> 3 mT
  //  namestr[4]="20210716232122_list.root";
  // namestr[4]="20210717001854_list.root";
  ...
  // Hysteresis1&2
  degstr[1]="B = 0 mT AFP OFF (sample C, Fe 90 nm)" ;
  degstr[2]="B = 0 mT AFP ON (sample C, Fe 90 nm)" ;
