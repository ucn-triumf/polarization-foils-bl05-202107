...
TString rootfile  = "20210714184125_list.root"; // name of the target root file
...
Double_t x_cut_low = 61; // for transmission wave 
Double_t x_cut_up =  65; // for transmission wave 
...
const Double_t endX = 128;//-0.5*128+64=0->x_true=-0.5*122.5-0.13
const Double_t startY = 0;
const Double_t endY = 128;
const Int_t nBinCut = 200;


void Draw2D_av_direct_M1M2() {
  ...
  Double_t x_true=x_peak*122.5/128.-0.13;
  ...
  std::cout << "average x_true: " << x_true << " mm" << std::endl;
