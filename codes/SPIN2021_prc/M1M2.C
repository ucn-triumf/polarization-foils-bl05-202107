...
*/
  ...
  for(Int_t i=0; i<num; i++){
    ...
    TLine *l1 = new TLine (xbegin,1e-3,xbegin, 70);
    TLine *l2 = new TLine (60.5,1e-3,60.5, 70);
    l1->SetLineColor(6);
    l2->SetLineColor(6);
    l1->Draw("ehsames");
    l2->Draw("ehsames");
    
    TLine *l3 = new TLine (xend,1e-3,xend, 70);
    TLine *l4 = new TLine (xcenter1,1e-3,xcenter1, 70);
    l3->SetLineColor(1);
    l4->SetLineColor(1);
    l3->Draw("ehsames");
    l4->Draw("ehsames");
