...
double Spl1(double x1) {
  ...
  //double q22=q_coff/lam;//*(89.3295-65.4023)/(89.3295-60.4583);
  //double q11=0.8*q_coff/q_coff_true*q22;
  double q1=x1;

  double ww=3.E-03;//par[1];
  
  double qc=1.15300e-01;//1.35980e-01;//par[0];1.15300e-01   
  double R0=9.9e-01;//par[1];
  double mm2= 1.26869e-01 ;//6.56329e+00;//par[2];
  ...
  double uprate=0.5;//par[3];
  double downrate=0.5;//par[4];
  double qc_up=0.217;///(89.3295-65.4023)*(89.3295-60.4583);
  //double q13=0.13*0.8284697312*(89.3295-65.4023)/(89.3295-60.4583);//*(89.3295-65.4023)/(89.3295-60.4583);//*0.8284697312/(89.3295-65.4023)*(89.3295-60.4583);
  //double q145=0.145*0.8284697312*(89.3295-65.4023)/(89.3295-60.4583);//*(89.3295-65.4023)/(89.3295-60.4583);//*0.8284697312/(89.3295-65.4023)*(89.3295-60.4583);
  double mm=5.;
...
double Spl2(double *x, double *par){
  double x1=2*TMath::Pi()*((89.3295-65.4023)/1439.)/x[0];//(89.3295-65.4023)*(89.3295-60.4583);
  ...
  if(x1>0.13*0.8284697312*(89.3295-65.4023)/(89.3295-60.4583)){
      if(x1<0.145*0.8284697312*(89.3295-65.4023)/(89.3295-60.4583)){
        RR=(R0-Rup-Rup)/(Spl1(x1));
        //RR=(R0-Rup)/R0;;
      }
      else{
        //RR=(Spl1(x1)-Rup)/R0;
        RR=(Spl1(x1)-Rup-Rup)/(Spl1(x1));
      }
  }
  else{
    //RR=(Spl1(x1)-Rup)/R0;
...
double Spl3(double *x, double *par){
  double x2=2*TMath::Pi()* ((89.3295-65.4023)/1439.)/x[0];//(89.3295-65.4023)*(89.3295-60.4583);
  ...
  if(x1>0.13*0.8284697312*(89.3295-65.4023)/(89.3295-60.4583)){
      if(x1<0.145*0.8284697312*(89.3295-65.4023)/(89.3295-60.4583)){
        //RR=(R0-Rup-Rup)/R0;(Rup+Rdown)
        RR=(Rup-R0+Rup)/(Spl1(x1));
        //RR=(Rup-Spl1(x1)-Rup)/R0;
        //RR=(R0-Rup)/R0;
      }
      else{
        //RR=(Spl1(x1)-Rup-Rup)/R0;
        RR=(Rup-(Spl1(x1)-Rup))/(Spl1(x1));
        //RR=(Spl1(x1)-Rup)/R0;
      }
  }
  else{
...
TF1 *sp2 = new TF1("",Spl2,0.26,1.26,0);
TF1 *sp3 = new TF1("",Spl3,0.26,1.26,0);
...
Int_t global_proc_nospline_10mrad(){
