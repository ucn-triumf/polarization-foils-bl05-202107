...
fname = "gatenetlog_scan20210713_flipper_agilent_scan_rough_2_edit.txt"
...
kp_start = np.array(df_log[(df_log.index>=0)&(df_log.state=='start')].kp)
kp_end = np.array(df_log[(df_log.index>=0)&(df_log.state=='end')].kp)
