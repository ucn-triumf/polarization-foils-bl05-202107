...
*/
  //namestr[0]="20210713201748_list.root";
  namestr[0]="20210713202138_list.root"; //M1 reflect (direct) 1hour
  ...
  namestr[3]="20210713194524_list.root"; //1000mV
  ...
  */
  ...
  double anglerad=angle[2]/2.;
  double angledeg2=angle[2]*180./TMath::Pi()/2.;
  cout<<"angle2aaaaa"<<anglerad<<"rad_"<<angledeg2<<"deg"<<endl;

  //  TLegend* leg = new TLegend(0.15, 0.75, 0.4, 0.98,"");
  TLegend* leg = new TLegend(0.70, 0.50, 0.98, 0.70,"");
  leg->SetFillColor(0);
