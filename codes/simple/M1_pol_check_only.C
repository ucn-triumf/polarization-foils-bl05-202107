...
*/
  ...
  for(Int_t i=0; i<num; i++){
    ...
    TLine *l1[6];
    TLine *l2[6];
    l1[i] = new TLine (xbegin[i],1e-3,xbegin[i],230);
    l2[i] = new TLine (xcenter[i],1e-3,xcenter[i], 230);
    ...
    TLine *l3 = new TLine (xend,1e-3,xend, 230);
    TLine *l4 = new TLine (xcenter1,1e-3,xcenter1, 230);
    l3->SetLineColor(1);
    l4->SetLineColor(1);
    l3->Draw("ehsames");
    l4->Draw("ehsames");
