...
Int_t M1_q_R_I_direct(){
  ...
  namestr[1]="20210713203512_list.root";

  //namestr[2]="20210713215303_list.root";
  namestr[2]="20210713220438_list.root"; 

  namestr[3]="20210713210310_list.root"; //Fe 30 nm, theta = 0.69 deg., x = 0.0 mm, B = 1 mT from -8 mT  with AFP 760 mV
  namestr[4]="20210713210556_list.root"; //Fe 30 nm, theta = 0.69 deg., x = 0.0 mm, B = 1.5 mT from -8 mT  with AFP 760 mV
  namestr[5]="20210713212050_list.root"; 
