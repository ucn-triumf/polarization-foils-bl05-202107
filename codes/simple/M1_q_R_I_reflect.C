...
*/
  angle[0] = TMath::Abs(70.5 - xdirect)/dist_det; //rad
  angle[1] = TMath::Abs(66.3179 - xdirect)/dist_det; //rad
  angle[2] = TMath::Abs(68.0634 - xdirect)/dist_det; //rad
  angle[3] = TMath::Abs(68.4197 - xdirect)/dist_det; //rad
  angle[4] = TMath::Abs(68.0501 - xdirect)/dist_det; //rad
  angle[5] = TMath::Abs(68.06 - xdirect)/dist_det; //rad
