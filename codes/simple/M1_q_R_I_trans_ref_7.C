...
*/
  ...
  TLegend* leg = new TLegend(0.75, 0.60, 1.00, 1.0,"");
  leg->SetFillColor(0);
  ...
  //Double_t xbegin=40.;
  //Double_t xcenter=80.;
  Double_t xbegin[6]={0,45.,60,60,60,60};
  Double_t xcenter[6]={0,55,70,70,70,70};
  ...
  for(Int_t i=0; i<num; i++){
    ...
    tup[i]->SetAlias("toffo","(tof>9.5e3)*(tof)+(tof<9.5e3)*(tof+40.e3)"); // edited based on suggestion by KM on the August 3rd
