...
const string run_id="20210717002421";//20210717002421_list_07
//const string run_id="20210717030252";
const Int_t num = 4; // this should be the half of the number of the files obtained by the scan 
 ...
 */  
    ...
    hq1[i]->GetYaxis()->SetRangeUser(1.e-3,1.1);
