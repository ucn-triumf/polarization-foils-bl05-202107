...
const string scan_id = "50nm_scan_fine_5";
const string run_id="20210717061701";
const Int_t num = 6; // this should be the half of the number of the files obtained by the scan 
 ...
 */  
    ...
    if(i!=0){
      ...
      ///8/29 add
      f0->SetParameter(0.,50.e-9);//m //第１引数が変数の番号、第２引数がその値
