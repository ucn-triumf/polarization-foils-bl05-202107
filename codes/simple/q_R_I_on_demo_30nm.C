...
Int_t q_R_I_on_demo_30nm(){
  ...
  namestr[1]="20210715072653_list.root";
  namestr[2]="20210715073913_list.root";
...
// AH's original
  ...
  degstr[1]="H = 8.01 mT, SF OFF";;
  degstr[2]="H = 8.01 mT, SF ON";
  

  Double_t angle[num];
 
  angle[0] = TMath::Abs(70.5 - xdirect)/dist_det; //rad
  angle[1] = TMath::Abs(47.1868  - xdirect)/dist_det; //rad
  angle[2] = TMath::Abs(47.1293 - xdirect)/dist_det; //rad
  ...
  c1->SaveAs(path_R+"q_R_I_off_on_30nm.png");
  c1->SaveAs(path_R+"q_R_I_off_on_30nm.root");
