...
Int_t q_R_I_on_demo_90nm(){
  ...
  namestr[1]="20210716232122_list.root";
  namestr[2]="20210716233530_list.root";
...
// AH's original
  ...
  angle[1] = TMath::Abs(47.3261 - xdirect)/dist_det; //rad
  angle[2] = TMath::Abs(47.2318 - xdirect)/dist_det; //rad
  ...
  c1->SaveAs(path_R+"q_R_I_off_on_90nm.png");
  c1->SaveAs(path_R+"q_R_I_off_on_90nm.root");
