...
int main(int argc, char *argv[])
{
  ...
  MakeNikiFRP(DataFileName); //for RPMT 
...
Int_t *MakeNiki(char* DataFileName)
{
  ...
  while(1){
    ...
    //if time is later than sett+dt, then Fill data in tuple
      ...
      if((sRpmt.iPulse[0]+sRpmt.iPulse[1])!=0)  RPMT_X = Double_t(sRpmt.iPulse[1]+sRpmt.iPulse[2])/Double_t(sRpmt.iPulse[0]+sRpmt.iPulse[1]+sRpmt.iPulse[2]+sRpmt.iPulse[3]);
      else  RPMT_X = -1.;
