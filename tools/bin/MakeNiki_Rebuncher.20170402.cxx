...
Int_t *MakeNiki(char* DataFileName)
{
  ...
  while(1){
    ...
    else if(ch==stp_ch && e > kp_LLD && e<kp_HLD){
      stp++;
      tzerostp=t; 
    }
...
//    ucntof = (Double_t)(t-tzeroucn);
    if(ch == dun_ch) ucntof = (Double_t)(t-tzerostp);
